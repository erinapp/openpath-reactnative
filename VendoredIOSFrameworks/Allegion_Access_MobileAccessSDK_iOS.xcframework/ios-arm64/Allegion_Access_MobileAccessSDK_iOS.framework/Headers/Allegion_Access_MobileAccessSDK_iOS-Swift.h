...
///
/// do {
///    try deviceSearch.searchForDevices(withDuration: 10.0, deviceTypes: [AlDeviceType.platinum.rawValue])
/// } catch {
///    // Handle an error response
/// }
///
...
///
/// do {
///    try deviceSearch.cancelSearch(deviceTypes: [AlDeviceType.platinum.rawValue])
/// } catch {
///    // Handle an error response
/// }
///
...
/// <ul>
///   <li>
///     <code>platinum</code>: Capable of receiving a platinum formed payload sent via BLE
///   </li>
///   <li>
...
///
- (nonnull instancetype)initWithRightID:(NSUUID * _Nonnull)rightID type:(NSString * _Nonnull)type credential:(NSData * _Nonnull)credential OBJC_DESIGNATED_INITIALIZER;
/// unique id for parent access right <code>AlRight.id</code>
@property (nonatomic, readonly, copy) NSUUID * _Nonnull rightID;
/// <code>AlDeviceType</code> for access payload
@property (nonatomic, readonly) enum AlDeviceType devicetype;
...
///
/// \endcode<h2>Example 2 - Pull Payloads:</h2>
/// \code
/// guard let rightID = UUID(uuidString: "38b76656-7eb4-41a5-a2ca-ac6dc761253d") else {
///    // Handle UUID construction error
/// }
...
/// \param accessToken Token to identify the user in MAH.
///
/// \param payloadTypes Type of payload [<code>AlDeviceType</code>] to retrieve.
///
